              ...
              <div className="h-100 d-lg-inline-flex align-items-center">
                <ul className="app-nav">
                  ...
                  <li className="dropdown">
                    <a className="app-nav__item notification-num" href="#" data-toggle="dropdown" aria-label="Show notifications"><i className="icon-bell"></i>
                      <span className="num">5</span>
                    </a>
                  </li>
                  {/* User Menu */}
                  <li className="dropdown">
                    <a className="app-nav__item dropdown-toggle" href="#" data-toggle="dropdown" aria-label="Open Profile Menu">Admin</a>
